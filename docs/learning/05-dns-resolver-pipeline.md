...
Open [`internal/interfaces/dns/handler.go`](../../backend/internal/interfaces/dns/handler.go). This thin layer
...
Open [`internal/modules/resolver/engine/resolver.go`](../../backend/internal/modules/resolver/engine/resolver.go).
...
[`internal/modules/resolver/engine/matching.go`](../../backend/internal/modules/resolver/engine/matching.go)
...
Open [`internal/modules/resolver/engine/responses.go`](../../backend/internal/modules/resolver/engine/responses.go).
...
1. **Read a step, predict a reply.** Without running, what does OmniDNS return
   ...
   [`resolver_test.go`](../../backend/internal/modules/resolver/engine/resolver_test.go).
