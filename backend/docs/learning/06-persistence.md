...
- **`QueryRow`** — exactly one row. From
  [`internal/db/records.go`](../../internal/db/records.go):
...
see [`internal/db/repositories/records.go`](../../internal/db/repositories/records.go).
...
spans three methods in [`internal/db/auth.go`](../../internal/db/auth.go).
...
[`session_test.go`](../../internal/db/session_test.go) pin all three behaviors.
...
**implementations** live in [`internal/db/repositories/`](../../internal/db/repositories/),
the only place that knows both SQL *and* domain types. Example —
[`repositories/records.go`](../../internal/db/repositories/records.go):
...
`SaveSettings` in [`internal/db/queries.go`](../../internal/db/queries.go):
